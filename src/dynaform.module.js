System.register(['@angular/core', '@angular/platform-browser', '@angular/forms', './controls-components/dynamic-form-component', './control-meta/PropertyHandler', './controls-components/text-control', './controls-components/number-control', './controls-components/checkbox-control', './controls-components/radio-control', './controls-components/email-control', './controls-components/select-control', './controls-components/validation-messages-block'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, forms_1, dynamic_form_component_1, PropertyHandler_1, text_control_1, number_control_1, checkbox_control_1, radio_control_1, email_control_1, select_control_1, validation_messages_block_1;
    var DynaFormModule;
    return {
        setters:[
            function (core_1_1) {
